...
urlpatterns = [
    ...
    path('myadmin/add_book/', views.addBook, name='add_book'),
    path('add_book/checkid/', views.checkID, name='checkid'),
    path('myadmin/add_book/checkid/', views.checkID, name='checkid'),
    path('add_book/addBook/', views.addBook, name='addBook'),
    path('myadmin/add_book/addBook/', views.addBook, name='addBook'),

    path('add_book/myadmin/', views.myadmin),
    path('myadmin/add_book/update_book/', views.update_book_view, name='update_book'),
